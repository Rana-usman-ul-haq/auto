...
contract HexInferno is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Hex Inferno";
    string private _symbol = "HIN";
    ...
    uint256 public _liquidityFee = 5; // buybackfee + marketingDivsor
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            ...
            require(_isTradeOpen, "Trade is closed");
        }
